  ...
  <header>
    ...
    <nav>
      <ul class="topnav" id="dropDownClick">
        ...
        <li><a href="#home"  onclick="closeDropDownMenu();" class="active-links">Home</a></li>
        <li><a href="#about"  onclick="closeDropDownMenu();"  class="active-links">About</a></li>
        <li><a href="#menu"  onclick="closeDropDownMenu();"  class="active-links">Menu</a></li>
      <!--  <li><a href="#">Specials</a></li> -->

        <li><a href="#gallery"  onclick="closeDropDownMenu();"  class="active-links">Gallery</a></li>
        <li><a href="#contact"  onclick="closeDropDownMenu();"  class="active-links">Contact</a></li>
          <li>
...
Best place to buy Birthday cakes, Kids cakes, Customized cakes,<br /> photo cakes & Cup Cakes delivery available in Kuruwita

      </h1>


<p class="aboutp1">
Cake N Bake delivers fresh variety of cakes in Dubai, UAE.<br /> Order now to give your taste buds special treat with cakes.
</p>

<ol>

  <li class="about-li">
<i class="fa fa-circle" style="color:#7e5936;"></i>
CUSTOMISED CAKES,
  </li>

    <li class="about-li">
  <i class="fa fa-circle" style="color:#7e5936;"></i> OCCASION CAKES
    </li>
    ...
    <div class=" col-sm-12 col-lg-4 whyUs-title1">
      <div class="img-fluid size-img whyus-div">
        <div class="whyus-content">
          ...
          <h1 class="whyus-h1-caption">lovely environment</h1>
          <p class="whyus-p-paragraph">
        A nice and lovely environment forces you to come back for another date. In a food bakery.
        ...
        <div class=" col-sm-12 col-lg-4 whyUs-title2">
          <div class="img-fluid size-img whyus-div">
            <div class="whyus-content">
              ...
              <h1 class="whyus-h1-caption">  Quality </h1>
              <p class="whyus-p-paragraph">
            Quality is free, excellent is priceless
            ...
            <div class=" col-sm-12 col-lg-4 whyUs-title3">
              <div class="img-fluid size-img whyus-div">
                <div class="whyus-content">
                  ...
                  <h1 class="whyus-h1-caption">The service</h1>
                  <p class="whyus-p-paragraph">
                A service that not only brings out the best in the
                <br />client but also their own inner strength.
...
<divition class="Menu scrollrel-title" id="menu">
...
-->
<divition class="Gallery" id="gallery">
  <div class="whysus-content">
...
<divition class="Contact" id="contact">
